          ...
          <div className="text-left order-1 lg:order-none"> 
            ...
            <div className={`transition-all duration-700 delay-300 ease-out ${
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 sm:mt-7 md:mt-8">
                <button className="group relative px-5 sm:px-6 md:px-8 py-3 sm:py-3.5 rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold text-sm sm:text-base shadow-lg shadow-indigo-300/40 hover:shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden w-full sm:w-auto">
                  <span className="relative z-10">Customize your card →</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                </button>
                <a href="/templates" className="w-full sm:w-auto">
                  <button className="w-full sm:w-auto px-5 sm:px-6 md:px-8 py-3 sm:py-3.5 rounded-full border-2 border-slate-200 bg-white text-slate-700 font-bold text-sm sm:text-base hover:border-indigo-300 hover:text-indigo-600 hover:bg-indigo-50/30 transition-all duration-300">
                    View Templates
                  </button>
                </a>
              </div>
